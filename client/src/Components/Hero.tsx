...
function Hero() {
  return (
    <section className=" bg-blue text-white">
      ...
      >
        <div className="self-center justify-self-center w-4/10 mr-0 font-bold">
          <h1 className="text-7xl ">Find Your Dream Job with Ease</h1>
          <p>Search, Apply, and Track Job Applications All in One Place</p>
        </div>
        <div className="place-self-end  -mb-25 -mr-50 ">
